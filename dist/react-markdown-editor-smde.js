(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('marked/index'), require('react'), require('easymde')) :
    typeof define === 'function' && define.amd ? define(['exports', 'marked/index', 'react', 'easymde'], factory) :
    (global = global || self, factory(global['react-markdown-editor-smde'] = {}, global.index, global.React, global.EasyMDE));
}(this, (function (exports, index, React, EasyMDE) { 'use strict';
    ...
    var mdToHTML = function (md, markedOptions) {
        ...
        try {
            ...
            if (typeof markedOptions === 'object' && Object.keys(markedOptions).length > 0) {
                // Set options
                index.marked.use.apply(index.marked, __spreadArrays([markedOptions], others));
            }
            return index.marked.parse(_md);
        }
        catch (error) {
            return '';
        }
